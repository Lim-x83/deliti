...
class _MenuPageState extends State<MenuPage> {
  ...
  Future<void> _loadMenuItems() async {
    try {
      print('🔄 Loading menu from: ${ApiService.baseUrl}/get_menu.php'); // DEBUG      
  ...
  Widget _buildMenuItem(BuildContext context, dynamic menuItem) {
    return Card(
      ...
      child: ListTile(
        leading: _buildMenuItemImage(menuItem['image_path']),
        title: Text(
          menuItem['name'],
          style: const TextStyle(
            fontWeight: FontWeight.bold,
        ...
        subtitle: Text(
          'Rp ${double.parse(menuItem['price']).toStringAsFixed(0)}',
          style: const TextStyle(
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => FoodDetailPage(
                menuItem: MenuItemModel.fromJson(menuItem),
